...
$P(X ≥ 1) = 1 - P(X = 0)$ # Autrement dit, la probabilité qu'on ne trouve pas aucune clé antique <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $=  1 - \binom{n}{0} * 0.005^0 * (1 - 0.005)^n$  # la formule exacte de p parmi n est $\frac{n!}{p!(n - p)!}$, mais 0 parmi n'importe quel nombre vaut 1<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $= 1 - 1 * 1 * 0.995^n$<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; $= 1 - 0.995^n$<br>
